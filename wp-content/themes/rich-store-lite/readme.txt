...
Tags: two-columns,right-sidebar,custom-background,custom-colors,custom-header,custom-logo,custom-menu,editor-style,featured-images,full-width-template,threaded-comments,
theme-options,translation-ready,blog,e-commerce
...
3 - Oswald: https://fonts.google.com/specimen/Oswald
	License: Distributed under the terms of SIL Open Font License, Version 1.1.	
...
7 rich-store-lite/customize-pro	
