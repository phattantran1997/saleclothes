...
<div class="container">
	<div class="content-area">
		<main id="main" class="site-main" role="main">
			<?php
			    $layout_option = get_theme_mod( 'lz_fashion_ecommerce_theme_options',__( 'Right Sidebar','lz-fashion-ecommerce' ) );
					    	...
					    	<section id="post_section">
								...
								while ( have_posts() ) : the_post();
									...
									the_post_navigation( array(
										'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'lz-fashion-ecommerce' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Previous', 'lz-fashion-ecommerce' ) . '</span>',
										'next_text' => '<span class="screen-reader-text">' . __( 'Next Post', 'lz-fashion-ecommerce' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Next', 'lz-fashion-ecommerce' ) . '</span> ',
									) );
								...
								<div class="navigation">
					                <?php
					                    ...
					                    the_posts_pagination( array(
					                        'prev_text'          => __( 'Previous page', 'lz-fashion-ecommerce' ),
					                        'next_text'          => __( 'Next page', 'lz-fashion-ecommerce' ),
					                        'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'lz-fashion-ecommerce' ) . ' </span>',
					                    ) );
					                ?>
					                <div class="clearfix"></div>
					            </div>
